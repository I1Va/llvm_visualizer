...
int GraphSerializer::serialize(const gb::GraphBuilder &builder, const std::string &filename) {
...
void GraphSerializer::deserialize(gb::GraphBuilder &builder, const std::string& filepath) {
