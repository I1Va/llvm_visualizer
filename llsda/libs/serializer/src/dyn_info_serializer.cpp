...
int DynInfoSerializer::serialize(const DynamicInfo &info, const std::string& filename) {
...
void DynInfoSerializer::deserialize(DynamicInfo &info, const std::string& filepath) {
    instrumentation::ExecutionData proto_data;
