; ModuleID = 'c_examples/fact.c'
source_filename = "c_examples/fact.c"
...
define dso_local range(i32 0, 2) i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #1 {
  %3 = icmp eq i32 %0, 2
...
18:                                               ; preds = %6
  %19 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.2)
  br label %20
